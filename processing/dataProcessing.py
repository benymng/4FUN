...
#these are the functions for finding the number of "true" reps based on which way the sensor is pointed towards
...
#velocityX, velocityY = movingAverage(velocityX, velocityY, 20)
...
#accelX, accelY = movingAverage(accelX, accelY, 0.0000001)
